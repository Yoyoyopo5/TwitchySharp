...
/// </summary>
public record ChannelPointsAutomaticRewardRedemptionAddCondition
{
    /// <summary>
    /// The user id of the broadcaster (channel) to get Channel Points Automatic Reward Redemption Add notifications for.
    /// </summary>
