...
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Automod.Message;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Automod.Settings;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Automod.Terms;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.AdBreak;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.ChannelPoints;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.CharityCampaign;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Chat;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.ChatSettings;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Goals;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.GuestStar;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.HypeTrain;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Moderator;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Polls;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Predictions;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.SharedChat;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.ShieldMode;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Shoutout;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Subscription;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.SuspiciousUser;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.UnbanRequest;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Vip;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Warning;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Conduit;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Drops;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Extension;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Stream;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.User;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.User.Authorization;
using TwitchySharp.Api.Models.Helix.EventSub.Models.Types.User.Whisper;
...
public class EventSubFixture : HelixFixture, IAsyncLifetime
{
    ...
    private async ValueTask<IReadOnlyDictionary<string, IEventSubSubscriptionType>> GenerateTypeMapAsync()
    {
        ...
        return new Dictionary<string, IEventSubSubscriptionType>
        {
            ...
            { nameof(ConduitShardDisabled), new ConduitShardDisabled(Secrets.Client.Id) },
            { nameof(DropEntitlementGrant), new DropEntitlementGrant(organizationId) },
            { nameof(ExtensionBitsTransactionCreate), new ExtensionBitsTransactionCreate(Secrets.Client.Id) },
            { nameof(StreamOffline), new StreamOffline(broadcasterId) },
            { nameof(StreamOnline), new StreamOnline(broadcasterId) },
            { nameof(UserAuthorizationGrant), new UserAuthorizationGrant(Secrets.Client.Id) },
            { nameof(UserAuthorizationRevoke), new UserAuthorizationRevoke(Secrets.Client.Id) },
