...
public record EventSubSubscriptionType(string Type, string Version)
{
    ...
    /// </summary>
    public static EventSubSubscriptionType HypeTrainBegin { get; } = new(EventSubSubscriptionTypeNames.HYPE_TRAIN_BEGIN, VERSION_2);

    /// <summary>
    /// A Hype Train makes progress on the specified channel.
    /// </summary>
    public static EventSubSubscriptionType HypeTrainProgress { get; } = new(EventSubSubscriptionTypeNames.HYPE_TRAIN_PROGRESS, VERSION_2);

    /// <summary>
    /// A Hype Train ends on the specified channel.
    /// </summary>
    public static EventSubSubscriptionType HypeTrainEnd { get; } = new(EventSubSubscriptionTypeNames.HYPE_TRAIN_END, VERSION_2);
