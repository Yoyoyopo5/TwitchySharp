...
/// <summary>
/// An EventSub subscription type specification.
/// </summary>
/// <remarks>
/// Includes both the <see cref="EventSubSubscriptionType"/> and the subscription condition.
/// </remarks>
public interface IEventSubSubscriptionTypeSpecification
{
    /// <summary>
