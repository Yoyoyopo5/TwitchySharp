...
public sealed record ChannelPointsCustomRewardUpdate(UserId BroadcasterUserId, RewardId? RewardId = null)
    : EventSubSubscriptionTypeSpecification, IConditionConstructable<ChannelPointsCustomRewardUpdate>
{
    public override EventSubSubscriptionType Type => EventSubSubscriptionType.ChannelPointsCustomRewardUpdate;
    public static EventSubSubscriptionType SubscriptionType => EventSubSubscriptionType.ChannelPointsCustomRewardUpdate;
    ...
    public static Validation<ChannelPointsCustomRewardUpdate> FromCondition(IReadOnlyDictionary<ConditionKey, string> condition)
        => condition
            ...
            .Map(_ => new ChannelPointsCustomRewardUpdate(BroadcasterUserId, RewardId));
}
