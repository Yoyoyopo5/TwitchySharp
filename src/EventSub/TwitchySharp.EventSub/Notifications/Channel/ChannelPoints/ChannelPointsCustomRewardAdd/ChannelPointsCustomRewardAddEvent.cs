...
/// </summary>
/// <remarks>
/// See <see href="https://dev.twitch.tv/docs/eventsub/eventsub-reference/#channel-points-custom-reward-add-event">Channel Points Custom Reward Add Event</see> for more information.
/// </remarks>
public record ChannelPointsCustomRewardAddEvent
{
    /// <summary>
    /// The id of the custom channel points reward.
    /// </summary>
