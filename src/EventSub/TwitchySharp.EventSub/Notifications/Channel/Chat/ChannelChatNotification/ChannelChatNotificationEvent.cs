...
public record ChannelChatNotificationEvent
{
    ...
    /// </summary>
    public required RgbColor Color { get; init; } // Not sure if this is actually required, need to test with unset user color. Pretty sure it is set to empty string.
    /// <summary>
