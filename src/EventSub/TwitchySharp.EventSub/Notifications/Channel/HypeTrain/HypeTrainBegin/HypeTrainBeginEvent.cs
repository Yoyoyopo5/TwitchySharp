...
/// <summary>
/// Contains information about a specific <see cref="EventSubSubscriptionType.HypeTrainBegin"/> event.
/// </summary>
public record HypeTrainBeginEvent
{
    /// <summary>
    ...
    /// </summary>
    public required HypeTrainLevel AllTimeHighLevel { get; init; }
    /// <summary>
    /// The highest total points this type of Hype Train has ever reached for the broadcaster.
    /// </summary>
    public required HypeTrainPointCount AllTimeHighTotal { get; init; }
}
