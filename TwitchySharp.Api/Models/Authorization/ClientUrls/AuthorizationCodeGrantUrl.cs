...
namespace TwitchySharp.Api.Models.Authorization.ClientUrls;
/// <summary>
    ...
    : AuthorizationUrl
{
    ...
    public AuthorizationCodeGrantUrl(
        string clientId,
        string redirectUri,
        ...
        : base(clientId, redirectUri, RESPONSE_TYPE, scopes, state, nonce, claims, forceVerify) { }
}
