...
using TwitchySharp.Api.Models.Helix.HypeTrain.Responses;
using TwitchySharp.Api.Models.Shared;
using TwitchySharp.Helpers;

namespace TwitchySharp.Api.Models.Helix.HypeTrain.Requests;
/// <summary>
...
/// </remarks>
public record GetHypeTrainEventsRequest
    : TwitchHelixRequest<GetHypeTrainEventsResponse>
{
    ...
    /// </param>
    public GetHypeTrainEventsRequest(
        string clientId,
        string accessToken,
