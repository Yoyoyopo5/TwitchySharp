...
using TwitchySharp.Api.Models.Helix.Streams.Responses;
using TwitchySharp.Api.Models.Shared;
using TwitchySharp.Helpers;

namespace TwitchySharp.Api.Models.Helix.Streams.Requests;
/// <summary>
...
/// </remarks>
public record GetStreamsRequest : TwitchHelixRequest<GetStreamsResponse>
{
