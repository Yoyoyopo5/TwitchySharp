...
namespace TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Subscription;
/// <summary>
...
/// </param>
public sealed record ChannelSubscriptionGift(string BroadcasterUserId)
    : IEventSubSubscriptionType
{
    public string Type => EventSubSubscriptionTypeNames.CHANNEL_SUBSCRIPTION_GIFT;
