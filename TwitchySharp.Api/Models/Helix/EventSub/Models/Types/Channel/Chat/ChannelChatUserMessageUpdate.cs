...
namespace TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Chat;
/// <summary>
...
public sealed record ChannelChatUserMessageUpdate(string BroadcasterUserId, string UserId)
    : IEventSubSubscriptionType
{
    public string Type => EventSubSubscriptionTypeNames.CHANNEL_CHAT_USER_MESSAGE_UPDATE;
