...
namespace TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.ChannelPoints;
/// <summary>
...
public sealed record ChannelPointsCustomRewardRemove(string BroadcasterUserId, string? RewardId = null)
    : IEventSubSubscriptionType
{
    public string Type => EventSubSubscriptionTypeNames.CHANNEL_POINTS_CUSTOM_REWARD_REMOVE;
