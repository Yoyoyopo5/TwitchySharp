...
namespace TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Polls;
/// <summary>
...
/// </param>
public sealed record ChannelPollBegin(string BroadcasterUserId)
    : IEventSubSubscriptionType
{
    public string Type => EventSubSubscriptionTypeNames.CHANNEL_POLL_BEGIN;
