...
namespace TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.ShieldMode;
/// <summary>
...
/// </param>
public sealed record ShieldModeEnd(string BroadcasterUserId, string ModeratorUserId)
    : IEventSubSubscriptionType
{
    public string Type => EventSubSubscriptionTypeNames.SHIELD_MODE_END;
