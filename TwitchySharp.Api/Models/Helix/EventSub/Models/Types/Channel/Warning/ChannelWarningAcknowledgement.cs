...
namespace TwitchySharp.Api.Models.Helix.EventSub.Models.Types.Channel.Warning;
/// <summary>
...
/// </param>
public sealed record ChannelWarningAcknowledgement(string BroadcasterUserId, string ModeratorUserId)
    : IEventSubSubscriptionType
{
    public string Type => EventSubSubscriptionTypeNames.CHANNEL_WARNING_ACKNOWLEDGEMENT;
