...
namespace TwitchySharp.Api.Models.Helix.EventSub.Models.Types.User.Authorization;
/// <summary>
...
/// </param>
public sealed record UserAuthorizationGrant(string ClientId)
    : IEventSubSubscriptionType
{
    public string Type => EventSubSubscriptionTypeNames.USER_AUTHORIZATION_GRANT;
