...
public record AddBlockedTermRequest : TwitchHelixRequest<AddBlockedTermResponse>
{
    ...
    public override IReadOnlySet<Scope> ValidScopes => ImmutableHashSet.Create(Scope.ModeratorManageBlockedTerms);
...
{
    /// <summary>
    /// The word or phrase to block from being used in the broadcasterÅfs chat room.
    /// </summary>
    /// <remarks>
    /// <para>
