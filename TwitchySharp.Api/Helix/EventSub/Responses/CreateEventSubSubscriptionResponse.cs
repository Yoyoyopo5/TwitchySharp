...
public record CreateEventSubSubscriptionResponse
{
    ...
    /// </summary>
    public required CreatedEventSubSubscription[] Data { get; init; }
}

/// <summary>
/// Contains information about a newly created EventSub subscription.
/// </summary>
public record CreatedEventSubSubscription
{
    /// <summary>
