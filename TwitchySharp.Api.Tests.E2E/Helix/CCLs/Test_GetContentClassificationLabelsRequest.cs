...
using TwitchySharp.Api.Helix.CCLs.Enums;
using TwitchySharp.Api.Helix.CCLs.Requests;
using TwitchySharp.Api.Helix.CCLs.Responses;

namespace TwitchySharp.Api.Tests.E2E.Helix.CCLs;
[Collection("helix")]
