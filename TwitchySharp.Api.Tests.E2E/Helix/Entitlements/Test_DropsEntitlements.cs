...
using TwitchySharp.Api.Helix.Entitlements.Enums;
using TwitchySharp.Api.Helix.Entitlements.Responses;

namespace TwitchySharp.Api.Tests.E2E.Helix.Entitlements;
[Collection("helix")]
